...
export default function Results() {
  ...
  const columns: readonly ColumnConfig[] = [
    ...
    { key: "PredYear", label: "PredYear" },
    { key: "PredMonth", label: "PredMont" },
    { key: "TYear", label: "TYear" },
    { key: "TMonth", label: "TMonth" },
  ...
  const fetchBranchData = async (
    ...
    setLoading(true);
    try {
      let endpoint = `${process.env.NEXT_PUBLIC_BASE_URL}/aipredictions`;
